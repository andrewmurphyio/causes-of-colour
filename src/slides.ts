...
export const slides: Slide[] = [
  ...
  {
    id: 'brown-eye-mechanism',
    type: 'animation',
    animationId: 'brown-eye',
    title: 'Why Brown Eyes Are Brown',
    content: 'Melanin is the key — it selectively absorbs light.',
    background: 'dark',
  },
  {
    id: 'blue-eye-mechanism',
    type: 'animation',
    animationId: 'blue-eye',
    title: 'Why Blue Eyes Are Blue',
    content: 'No blue pigment — only structure and scattered light.',
    background: 'dark',
  },
  {
    id: 'hook-insight',
